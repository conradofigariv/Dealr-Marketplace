...
> **Atajo:** `supabase/apply_all.sql` es un script único e idempotente con 00008→00016. Pegarlo entero en el SQL Editor evita trackear migración por migración (se puede re-correr sin romper).
