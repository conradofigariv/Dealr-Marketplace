...
// de precio. Al tocar una, aparece una tarjeta abajo con el acceso al detalle.
export default function MapView() {
  ...
  return (
    <div className="fixed inset-0 z-10 bg-black">
      ...
      {/* Header flotante */}
      <div className="absolute inset-x-0 top-0 z-[500] flex items-center gap-3 bg-gradient-to-b from-black/80 to-transparent px-4 pb-8 pt-[max(1rem,env(safe-area-inset-top))]">
        <button
          onClick={() => navigate(-1)}
          aria-label="Volver"
          className="flex h-10 w-10 items-center justify-center rounded-full bg-black/70 text-white backdrop-blur-sm"
        >
