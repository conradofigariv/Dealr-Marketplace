...
export default function UpdatePrompt() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+5.5rem)] z-40 mx-auto flex max-w-lg px-4">
      <div className="flex flex-1 items-center justify-between gap-3 rounded-full bg-white px-4 py-2.5 shadow-lg">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="rounded-full bg-black px-3.5 py-1.5 text-xs font-semibold text-white"
          >
            Actualizar
          </button>
          <button onClick={() => setNeedRefresh(false)} aria-label="Cerrar" className="p-1 text-neutral-500">
